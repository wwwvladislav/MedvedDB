...
static mdv_errno mdv_cluster_reg_peer(mdv_cluster *cluster, char const *addr, mdv_uuid const *uuid, uint32_t *id)
{
...
static void mdv_cluster_unreg_peer(mdv_cluster *cluster, mdv_uuid const *uuid)
{
